...
curl -D- -X POST "https://laboratoriobfcl.atlassian.net/rest/api/3/issue/$TESTPLAN/attachments" -H 'X-Atlassian-Token: no-check' -F "file="@$WORKSPACE/results/ExtentPdf.pdf"" -H 'application/octet-stream' -H 'Authorization: Basic a2V2aW4ucGVuYUB0c29mdGxhdGFtLmNvbTplRTg4bk9kdWd6bFFSNWh5RVlwQ0Y4NDU= ' 
